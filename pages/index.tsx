...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <Head>
        <title>NLP Search - AI-Powered Product Search for E-commerce</title>
        <meta name="description" content="Enhance your e-commerce store with AI-powered product search" />
      </Head>
